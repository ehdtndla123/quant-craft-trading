...
from app.db.models import BotStrategy, Bot, Strategy


def create_bot_strategy(db: Session, bot_id: int, strategy_id: int) -> BotStrategy:
    new_bot_strategy = BotStrategy(bot_id=bot_id, strategy_id=strategy_id)
