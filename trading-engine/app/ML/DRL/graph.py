...
class Graph():
    def __init__(self):
        ...
        titles = ['profits', 'avg critic loss over episode', 'avg actor loss over episode', 'avg reward over 10 episodes']
    ...
    def draw_plots(self, episode):
        ...
        self.ax[0][0].plot(xaxis, self.data_outcome_history)
