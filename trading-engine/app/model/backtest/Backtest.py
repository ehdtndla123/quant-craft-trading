...
class Backtest:
    ...
    def __init__(self,
        ...
        if np.any(data['Close'] > cash):
            raise ValueError('Some prices are larger than initial cash value. Note that fractional '
        ...
        self._broker = partial(
            Broker, cash=cash, commission=commission, margin=margin,
    ...
    def compute_stats(
        ...
        return compute_stats(trades, equity, ohlc_data, strategy_instance, risk_free_rate)
